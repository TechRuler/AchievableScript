...
from src.editor.Line_Number.line_number import LineNumber
from src.gui.scrollbar import AutoScrollbar
from src.editor.Autocomplete.autocomplete import Autocomplete
from src.editor.syntax_highlighter.syntax_highligter import SyntaxHighlighter
from src.editor.minimap.minimap import TextPeer
