...
class SyntaxHighlighter:
    def __init__(self, master=None):
        ...
        self.master.tag_configure('keyword', foreground='blue')
        self.master.tag_configure('constant', foreground='tomato')
        self.master.tag_configure('self', foreground='tomato')
        self.master.tag_configure('parameter', foreground='purple')
        self.master.tag_configure('variable', foreground='black')
        self.master.tag_configure('special', foreground='blue')
        self.master.tag_configure('builtin', foreground='purple')
        self.master.tag_configure('method', foreground="spring green")
        self.master.tag_configure('number', foreground='red')
        self.master.tag_configure('comment', foreground='green')
        self.master.tag_configure('string', foreground='orange')
        self.master.tag_configure('user_def', foreground='tomato')  # New tag for user-defined elements
        self.master.tag_configure('class', foreground="spring green")
    ...
    def clear_tags(self):
        tags = ['keyword', 'constant', 'self','parameter','variable' ,'special', 'builtin', 'method', 'number', 'comment', 'string', 'module', 'user_module', 'user_def', 'class']
        for tag in tags:
